...
echo "================================"
echo "Ministack Resource Setup"
echo "================================"
echo ""
echo "Waiting for Ministack to be fully ready..."
sleep 10
...
echo "  3. Scan worker ECS service processes files from scan-queue"
...
echo ""
echo "Ministack is ready for testing!"
